...
export function LobbyHeader({ roomId, copied, onCopy, onExit }) {
  return (
    <header className="border-b border-[#E6DFD5] bg-canvas px-4 sm:px-8 py-3">
      <div className="mx-auto flex max-w-5xl items-center justify-between gap-4">
        ...
        {/* Room URL Pill with 1-Click Copy */}
        <div className="flex items-center gap-2 rounded-full border border-[#E6DFD5] bg-white px-3 py-1 text-xs">
